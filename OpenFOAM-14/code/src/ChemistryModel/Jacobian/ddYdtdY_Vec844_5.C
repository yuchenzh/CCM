/*---------------------------------------------------------------------------*\
  Description
      ...
      This variant (suffix 5) is specialised for nSpecie() % 8 == 5: the last five
      species (columns/rows Ns-5 .. Ns-1) are handled by a 4-species tail block
      plus a scalar tail for the last species.
